        ...
        <table class="budgetDivided">
            ...
            <tbody>
                <tr v-for="budget in budgets" :key="budget.id">
                    <td> 
                        <input type="checkbox" v-model="budget.selected" />
                    </td>
                    <td class="name">{{ budget.name }}</td>
                    <td>
                        <button type="split" @click="splitBudget(budget.amount)">Split</button>
                    </td>
                    <td>
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="amount totalDivided">{{ Math.ceil(totalDivided) }}</td>
                </tr>
                <tr v-for="income in incomes" :key="income.id">
                    <td>Remaining balance:</td>
                    <td>{{ Math.ceil(income.amount - totalDivided) }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
...
export default {
    ...
    methods: {
        ...
        splitBudget(){
            this.$emit('split:budget', this.budget)
            this.budget = {
                name: '',
                amount: ''
            }
