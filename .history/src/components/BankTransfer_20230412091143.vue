...
export default {
    ...
    methods: {
        ...
        transferSelectedBudget(){
            const selectedBudget = this.budgets.filter(budget => budget.selected === true && budget.amount > 0 )



            const selectedBank = this.banks.filter(bank => bank.selected === true && bank.amount > 0)
