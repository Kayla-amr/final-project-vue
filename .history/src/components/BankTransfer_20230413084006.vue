        ...
        <table class="table">
            <tbody>
                <tr v-for="bank in banks" :key="bank.id">
                    ...
                    <td class="button"> <button class="btn btn-neutral" type="delete" @click="removeBank(bank.id)">x</button></td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
...
//balance, cost, end of month balance, red style of negative balance, green style of positive balance, dropdown to show ind
