...
export default {
    ...
    methods: {
        ...
        transferSelectedBudget(){
            const selectedBudget = this.budgets.filter( (budget, index
            ) =>{
                this.budgets.forEach(budget => {
                    if(budget.selected === true){
                        total += budget.amount
                    }
                })
                return this.banks.forEach(bank => {
                    bank.amount += budget.amount
                })
            ...
            // console.log(selectedBudget)
            // const total = selectedBudget.reduce((total, budget) => {
