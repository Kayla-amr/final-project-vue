        ...
        <table class="table">
            <tbody>
                <tr v-for="bank in banks" :key="bank.id">
                    <td>{{ bank.name }}</td>
                    <td>{{ bank.amount }}</td>
                    <td><button class="btn btn-primary button" type="transfer" @click="transferSelectedBudget(bank.id)">-></button></td>
                    <td> <button class="btn btn-neutral button" type="delete" @click="removeBank(bank.id)">x</button></td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
