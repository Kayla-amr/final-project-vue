            ...
            <tbody>
                <tr v-for="bank in banks" :key="bank.id">
                    ...
                    <div class="bankbtn flex">
                        <td class="button"><ion-icon name="arrow-forward-circle-outline" size="large" class="btn btn-primary" type="transfer" @click="transferSelectedBudget(bank.id)"></ion-icon></td>
