        ...
        <table class="table">
            <tbody>
                <tr class="budgetList" v-for="budget in budgets" :key="budget.id">
                    <td class="name"> <input type="text" v-model="budget.name" class="bg-base-300 p-2"></td>
                    <td class="amount"><input type="text" v-model="budget.amount" class="bg-base-300 p-2"></td>
