            ...
            <tbody>
                <tr v-for="bank in banks" :key="bank.id">
                    ...
                    <div class="bankbtn flex">
                        <td class="button"><ion-icon name="arrow-forward-circle-outline" class="btn btn-primary" type="transfer" @click="transferSelectedBudget(bank.id)"></ion-icon></td>
                        <td class="button"><ion-icon name="swap-horizontal-outline"></ion-icon></td>
