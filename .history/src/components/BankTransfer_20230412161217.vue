        ...
        <table>
            <tbody>
                <tr v-for="bank in banks" :key="bank.id">
                    <td><button class="btn btn-primary" type="transfer" @click="transferSelectedBudget(bank.id)">Add</button></td>
                    <td>{{ bank.name }}</td>
                    <td>{{ bank.amount }}</td>
                    <td> <button class="btn btn-neutral" type="delete" @click="removeBank(bank.id)">-</button></td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
                    <button class="btn btn-error w-100" type="clear" @click="clearTransfer">Clear</button>
                </tr>
            </tfoot>
        </table>
    </div>
