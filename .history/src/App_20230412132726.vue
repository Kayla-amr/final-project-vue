...
export default {
    ...
    methods: {
        ...
        splitAmount() {
            const totalBudgets = this.budgets.reduce((total, budget) => {
            ...
            const total = totalIncomes - totalBudgets - totalBanks;

            const splitAmount = Math.ceil(total / this.banks.length);

            this.banks.forEach(bank => {
                bank.amount += splitAmount;
            })
        },
