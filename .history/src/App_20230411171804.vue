...
<template>
    ...
    <div id="app">
        ...
        <div class="bankTransferList">
            <bank-transfer @add:bank="addBanks" :budgets="budgets" :incomes="incomes"  :banks="banks" />
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        transferHere(bank, budget){
            const transferBudget = this.budgets.find(budget => budget.amount === budget.amount)
            const transferBank = this.banks.find(bank => bank.amount === bank.amount)
            transferBank.amount = transferBank.amount + transferBudget.amount
            transferBudget.amount = 0
