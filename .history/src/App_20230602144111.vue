...
<template>
    <div id="app">
        <div class="layoutapp">
            ...
            <p>
                A simple budget tracking app that allows you to create a list of expenses, calculate the divided expense's
                with bi-weekly pay, and add the selected expense's to your bank.
            </p>
            <div class="steps flex md:flex-nowrap">
                <div class="card w-11/12 bg-base-100 shadow-xl m-2">
                ...
                <div class="card w-11/12 bg-base-100 shadow-xl m-2">
                    <div class="card-body flex-col items-center">
                        <h2 class="card-title">Calculate</h2>
                        <p>
